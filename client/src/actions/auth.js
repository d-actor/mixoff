...
export const registerUser = (email, name, spotifyName, password, passwordConfirmation, history) => {
  return dispatch => {
    axios.post('/api/auth', { email, name, spotify_name: spotifyName, password, password_confirmation: passwordConfirmation })
      .then(res => {
